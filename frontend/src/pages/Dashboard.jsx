          ...
          <div key={p.id}
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <div className="text-right">
                <p className={`text-sm font-bold ${isOverdue?"text-red-600":isUrgent?"text-orange-600":"text-gray-700"}`}>
                  {isOverdue?`${Math.abs(p.daysLeft)}d ${t("dashboard.overdue")}`:`${p.daysLeft}d`}
                </p>
                <p className="text-[9px] text-gray-400">{p.planned_completion_date?new Date(p.planned_completion_date).toLocaleDateString("en-NP"):""}</p>
              </div>
...
<div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-3">
              ...
              abel={t("dashboard.on_track")}         val={stats.ongoing}     total={stats.total} color="bg-blue-500"    textColor="text-blue-700"/>
